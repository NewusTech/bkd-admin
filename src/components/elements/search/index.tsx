  ...
  return (
    <div className="w-full flex flex-row items-center px-4 border border-primary-40 bg-transparent rounded-lg gap-x-3">
      ...
      <input
        ...
        className="text-black-80 w-full text-[14px] md:text-[16px] h-[35px] active:border-x-line-40 focus:border-line-40 focus:outline-none active:outline-none placeholder:text-black-80 rounded-lg placeholder:text-[16px]"
      />
    </div>
  );
}
