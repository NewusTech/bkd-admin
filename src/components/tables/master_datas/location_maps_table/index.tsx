  ...
  return (
    <div className="w-full flex flex-col items-center gap-y-5">
      <div className="w-full flex flex-col md:flex-row bg-line-10 rounded-lg shadow-md py-3 items-center px-3 gap-y-5">
        <div className="w-full text-center md:text-start text-[18px] md:text-[20px]">
        ...
        <div className="w-full md:w-7/12 flex flex-row gap-x-3">
              ...
              {!isMobile ? (
                <AlertDialog
                  ...
                  <AlertDialogTrigger
                    ...
                    className="w-full">
                    <div className="w-full text-[16px] bg-black-80 bg-opacity-20 hover:bg-opacity-40 flex items-center justify-center h-10 text-black-80 hover:text-line-10 *:
                      ...
                      <form
                        ...
                        <div className="w-full flex flex-row justify-between items-center gap-x-5">
                          ...
                          <Button
                            ...
                            className="bg-primary-40 hover:bg-primary-70 text-line-10 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 text-[16px]">
                            {isUpdateLoading ? (
                ...
                <Drawer
                  ...
                  <DrawerTrigger
                    ...
                    <div className="w-full text-[14px] bg-line-40 bg-opacity-20 flex items-center justify-center hover:bg-line-70 h-10 text-black-80 hover:text-line-10 rounded-lg">
                      Edit
                    </div>
                  </DrawerTrigger>
                  <DrawerContent className="flex flex-col gap-y-3 bg-line-10 rounded-lg w-full max-w-4xl h-4/6 px-3 pb-6">
                    <div className="w-full flex flex-col gap-y-3 verticalScroll">
                      <DrawerTitle className="text-center text-[18px]">
          ...
          {/* <div className="w-full">
            <Button
              ...
              className="rounded-lg bg-error-60 hover:bg-error-70 text-line-10  transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 py-2 w-full text-[14px]">
              {isDeleteLoading ? (
                <Loader className="animate-spin" />
              ) : isDeleteLoading ? (
                ""
      ...
      <div className="w-full flex flex-col gap-y-5 bg-line-10 p-3 rounded-lg shadow-md">
        <section className="w-full flex snap-start scroll-mt-24 flex-col py-8 md:py-12 px-4 md:px-20 gap-y-8">
          <div className="w-full flex flex-col items-center gap-y-3">
            <h5 className="text-center text-black-80 px-6 md:px-0 text-[20px] font-semibold">
