...
import { AccountManagingRolesInterface, AreasInterface, RolesInterface } from "@/types/interface";
            ...
            <section className="w-full bg-line-10 rounded-lg shadow-md p-4 mb-4">
                ...
                <div className="text-[14px] flex flex-col gap-y-4">
                    ...
                    <div className="w-full grid grid-cols-3">
                        ...
                        <div className="w-full col-span-2">: {account?.name && account?.name}</div>
                    </div>
                    ...
                    <div className="w-full grid grid-cols-3">
                        ...
                        <div className="w-full col-span-2">: {account?.nip && account?.nip}</div>
                    </div>
