...
export default function MobileCarouselSliderMasterDataCard({
  ...
  return (
    <section className="w-full bg-line-10 rounded-lg shadow-md flex flex-col gap-y-4 md:gap-y-7 p-4 mb-4">
                          ...
                          <div className="w-full flex flex-col gap-y-3 verticalScroll">
                            <DrawerHeader>
                              <DrawerTitle className="text-center text-[16px]">
                                Master Data Carausel Slider
                              </DrawerTitle>
                              <form
                                onSubmit={(e: React.FormEvent<HTMLFormElement>) =>
                                  handleUpdateSlider(e, carousel?.id)
                                }
                                className="w-full flex flex-col gap-y-5 h-[500px]">
      ...
      <div className="w-full grid grid-cols-3">
        <div className="w-full text-[14px] text-left">Slider Dekstop</div>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent className="w-full max-w-2xl bg-line-10 rounded-lg shadow-md">
                ...
                <AlertDialogFooter className="w-full flex flex-row justify-center">
                  <AlertDialogCancel className="text-[14px]">Batal</AlertDialogCancel>
                </AlertDialogFooter>
              </AlertDialogContent>
            </AlertDialog>
          </div>
      ...
      <div className="w-full grid grid-cols-3 -mt-4">
        <div className="w-full text-[14px] text-left">Slider Mobile</div>
