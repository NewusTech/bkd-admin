...
import { getSatisfactionIndexHistoryReportDetail, getVerificationReportingsDetail } from "@/services/api";
...
export default function VerificationReportingsDetailScreen({
    ...
    const [indexes, setIndexes] =
        useState<StatisVerificationReportingsDetailInterface[]>([]);
    ...
    console.log(indexes, "ini indeks");
