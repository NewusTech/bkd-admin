        ...
        <section className="w-full flex flex-col items-center px-5 mt-5">
            <div className="bg-line-10 shadow-md rounded-lg w-full flex flex-col p-5 gap-y-5">
                ...
                <div className="w-full">
                    <div className="text-center mb-4 text-sm md:text-lg">Tambah Persyaratan</div>
                    ...
                    <div className="w-full border border-b rounded-lg z-50">
                        <Select
                            ...
                            onValueChange={((value: any) =>
                                setServiceId(Number(value)) // Set serviceId ketika layanan dipilih
                            )}
                        >
                            <SelectTrigger
                            ...
                            <SelectContent className="bg-line-10">
                                {services.map((service) => (
                                    <SelectItem key={service.id} className="w-full px-4 pl-8" value={service.id.toString()}>
                                        {service.nama}
                                    </SelectItem>
                                ))}
                            </SelectContent>
                ...
                <div className="flex justify-center m-auto items-center w-full mt-20">
                    <Button
                        onClick={() => {
                            router.push("/super-admin/master-data/service-requirements/create/step-2")
                        }}
