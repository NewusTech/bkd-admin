...
import { deleteAreas, getAreas, postAreas, updateAreas, serviceRequirementStep2 } from "@/services/api";
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setCards([]);
                router.push("/super-admin/master-data/service-requirements/create/step-3");
            } else {
                Swal.fire({
                    icon: "error",
        ...
        <>
            <section className="w-full flex flex-col items-center px-5 mt-5">
                <div className="bg-line-10 shadow-md rounded-lg w-full flex flex-col p-5 gap-y-5">
                    ...
                    {cards.map((card) => (
                        <div key={card.id} className="bg-white border border-[#E4E4E7] p-10">
